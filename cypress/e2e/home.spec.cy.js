...
describe('Home Page Tests', () => {
  ...
  it('TC-004: The “Log In” opens the login page', () => {
    homePage.getLogInButton().should('be.visible').invoke('removeAttr', 'target').click();
  ...
  it('TC-005: The Hero section contains an H1 heading and a CTA button', () => {
    ...
    it('TC-007: The CHAT TO AN AGENT accepts messages', () => {
        homePage.getInputChatToAnAgent('The test was successful').scrollIntoView().should('be.visible');
    ...
    it('TC-008: The "EXPLORE OUR AI ASSISTANT" page is accessible from the homepage', () => {
        ...
        homePage.getExploreOurAiAssistantButton().scrollIntoView().should('be.visible').click();
    ...
    it('TC-010: The footer contains links to the Privacy Policy and Terms of Service', () => {
      ...
      homePage.getPrivacyPolicyLink().should('be.visible').and('have.attr', 'href', '/privacy-policy');
      homePage.getTermsOfServiceLink().should('be.visible').and('have.attr', 'href', '/terms-and-conditions-of-service');
